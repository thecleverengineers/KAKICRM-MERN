...
export const navigation: Array<{ label: string; items: NavigationItem[] }> = [
  ...
  { label: 'Work', items: [{ label: 'Tasks', to: '/tasks', icon: CheckSquare, permission: 'task.view', roles: ['employee'] }, { label: 'Projects', to: '/projects', icon: BriefcaseBusiness, permission: 'departments.view' }, { label: 'Teams', to: '/data/teams', icon: UsersRound, permission: 'teams.view' }, { label: 'Drive', to: '/data/drive_items', icon: FolderOpen, permission: 'drive.view' }, { label: 'Credential Vault', to: '/credential-vault', icon: KeyRound }, { label: 'Remote Work', to: '/remote-work', icon: CalendarClock, permission: 'remotework.view' }] },
